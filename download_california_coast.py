#!/usr/bin/env python3
"""
Quick-start script to download California Coast (San Francisco Bay Area)

This location features:
- Urban coastal area with San Francisco Bay
- Low cloud cover in summer (5% threshold)
- Mix of urban, water, and natural terrain
- Excellent for water/land classification questions

Just run: python download_california_coast.py
"""
...
def main():
    ...
    location = {
        ...
        'end_date': '2023-09-30',
        'cloud_percentage': 5  # Low cloud threshold for summer California
    }
