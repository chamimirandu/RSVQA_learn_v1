#!/usr/bin/env python3
"""
Quick-start script to download Yellowstone National Park

This location features:
- National park with diverse natural features
- Geothermal areas, forests, and meadows
- Summer months only (Jul-Aug) to avoid snow
- Excellent for natural feature and terrain questions

Just run: python download_yellowstone.py
"""
...
def main():
    ...
    print(f"   Note: Summer months only to avoid snow\n")
